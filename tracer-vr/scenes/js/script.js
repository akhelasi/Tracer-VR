...
switch(vrScene) {
    ...
    case 2:
        ...
        getObjects(GLBLink, 'barrel_outer_vr.glb');
        getObjects(GLBLink, 'barrel_middle_vr.glb');
        getObjects(GLBLink, 'barrel_inner_vr.glb');
        break;
    ...
    case 4:
        ...
        getObjects(GLBLink, 'barrel_toroid.glb');
        getObjects(GLBLink, 'warm_structure.glb');
        getObjects(GLBLink, 'barrel_inner_vr.glb'); //es unda iyos  me-2, me-3, me-4 scenebshi
        break;
